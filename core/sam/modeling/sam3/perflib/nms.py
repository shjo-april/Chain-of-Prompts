...
from core.sam.modeling.sam3.perflib.masks_ops import mask_iou
...
try:
    ...
    logging.debug(
        "Falling back to CPU mask NMS implementation -- please install `torch_generic_nms` for GPU acceleration via\n\t"
