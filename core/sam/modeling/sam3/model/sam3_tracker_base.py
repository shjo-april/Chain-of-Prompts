...
from core.sam.modeling.sam3.model.memory import SimpleMaskEncoder

from core.sam.modeling.sam3.model.sam3_tracker_utils import get_1d_sine_pe, select_closest_cond_frames

from core.sam.modeling.sam3.sam.mask_decoder import MaskDecoder, MLP
from core.sam.modeling.sam3.sam.prompt_encoder import PromptEncoder
from core.sam.modeling.sam3.sam.transformer import TwoWayTransformer
...
class Sam3TrackerBase(torch.nn.Module):
    ...
    def _compile_all_components(self):
        ...
        from core.sam.modeling.sam3.perflib.compile import compile_wrapper
